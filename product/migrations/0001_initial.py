# Generated by Django 3.1.4 on 2021-05-23 11:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('threads', models.PositiveIntegerField(blank=True, choices=[(None, '(Unknown)'), (1, 'two threads'), (2, 'three threads')], null=True, verbose_name='threads')),
                ('contents', models.PositiveIntegerField(blank=True, choices=[(None, '(Unknown)'), (1, 'with lycra'), (2, '100% cotton')], null=True, verbose_name='contents')),
